    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                ...
                <a class="btn btn-success btn-xs pull-right pop" data-toggle="modal" href="{{ route('index-permission-role') }}" data-placement="left" data-content="click to redirect in permission role page" style="margin-right: 10px;">Go to Permission Role Page
                </a>
            </div>

...
<div class="modal-footer">
    <a href="{{route('index-permission')}}" class="btn btn-default" type="button" data-placement="top" data-content="click close button for close this entry form" onclick="close_modal();"> Close </a>
</div>

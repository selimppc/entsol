<div class="row">
    <div class="col-sm-12">
        @if(isset($data))
            <a href="{{ route('edit-user-profile', $data->id) }}" class="btn btn-primary btn-xs" data-placement="top" data-toggle="modal" data-target="#entsolModal" data-content="view" style="margin-left: 91%">Edit Profile</a>
        @else

...
class PermissionRoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user::permission_role.index', ['data' => $data, 'pageTitle'=> $pageTitle, 'permission_id'=>$permission_id]);
    }
    ...
    public function edit($id)
    {
        ...
        /*$role_id = [''=>'Select Permission'] + Role::lists('title','id')->all();*/
        return view('user::permission_role.update', ['data' => $data, 'pageTitle'=> $pageTitle, 'permission_id' => $permission_id]);
    }

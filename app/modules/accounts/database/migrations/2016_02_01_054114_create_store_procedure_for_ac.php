...
class CreateStoreProcedureForAc extends Migration
{
    ...
    public function up()
    {
        ...
        BEGIN
            INSERT INTO ac_balance(voucher_head_id, voucher_number,coa_id, account_code,sub_account_code,DATE,branch_id,branch,reference,YEAR,period,currency_id,exchange_rate,prime_amount,base_amount,STATUS,created_at,created_by)

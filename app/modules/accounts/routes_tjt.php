...
Route::any('journal-voucher-history/{id}', [
    'middleware' => 'acl_access:journal-voucher-history/{id}',
...
Route::any('search/autocomplete', [
    'middleware' => 'acl_access:search/autocomplete',
...
Route::any('journal-post/{voucher_number}', [
    'middleware' => 'acl_access:journal-post/{voucher_number}',
    'as' => 'journal-post',
    'uses' => 'VoucherDetailController@journal_post'
]);

Route::any('ajax-account-code', [
    'middleware' => 'acl_access:ajax-account-code',
...
Route::get('search-voucher', [
    'middleware' => 'acl_access:search-voucher',
    'as' => 'search-voucher',
...
Route::get('search-voucher-details/{id}/{voucher_number}', [
    'middleware' => 'acl_access:search-voucher-details/{id}/{voucher_number}',

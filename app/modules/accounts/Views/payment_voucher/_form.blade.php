...
<div class="form-group form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
        <div class="col-sm-6">
            ...
            {!! Form::selectrange('year',2010,2030, Input::old('year', date('Y')),['class' => 'form-control','required','title'=>'select payment voucher year']) !!}
        </div>
        <div class="col-sm-6">
            {!! Form::label('period', 'Period:', ['class' => 'control-label']) !!}
            {!! Form::selectrange('period', 1,12,Input::old('period', date('m')),['class' => 'form-control','required','title'=>'select payment voucher month']) !!}
        </div>
    </div>
</div>

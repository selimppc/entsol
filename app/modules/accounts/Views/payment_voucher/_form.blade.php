...
<div class="modal-body">
    ...
    <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
        <div class="row">
            {!! Form::hidden('account_type', 'payment-voucher') !!}
            <div class="col-sm-3">
    ...
    <table width="100%" id="table" class="table" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        <div>
                            ...
                            {!! Form::hidden('dt_id[]',@$value_dt['id'], ['class'=>'coa-id-val']) !!}
                        </div>
                    </td>
                    <td>
        ...
        <tr>
            <td>
                <div>
                    {!! Form::text('ac_title[]', Input::old('coa_id'), ['class'=>'auto-search-ac form-control','placeholder'=>'Search By account head or code','title'=>'type your require account head and code']) !!}
                </div>
            </td>
            <td>
...
<div class="modal-footer">
    ...
    <a href="{{route('payment-voucher')}}" class=" btn btn-default" data-placement="top" data-content="click close button for close this entry form" onclick="close_modal();">Close</a>
</div>

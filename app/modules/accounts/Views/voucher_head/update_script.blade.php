...
<script>
    ...
    $(document).on("focus",'#update-table tr:last-child td:last-child',function(e) {
        ...
        var element = '<tr>\
		<td><div> {!! Form::text('ac_title[]', Input::old('coa_id'), ['id'=>'coa_name2','class'=>'ac-auto-search-ac form-control','placeholder'=>'Search By account head or code','autofocus','title'=>'type your require account head and code']) !!}\
         </td>\
        ...
        //var coa_name = $("#coa_name").val();
            ...
            console.log($("#update-table tr:last-child").find(".ac-auto-search-ac"));
            //console.log($("#table tr:last-child").find(".coa-id-val"));
            $("#update-table tr:last-child").find(".ac-auto-search-ac").autocomplete({
                source: "{{Route('coa-list')}}",
                minLength: 1,
                select: function(event, ui) {

        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="input-group date">
                    {!! Form::text('date', @$generate_voucher_number? date('Y/m/d') : @$data[0]['date'], ['class' => 'bs-datepicker-component form-control','required','title'=>'select receipt voucher date']) !!}
...
@include('accounts::receipt_voucher._script')

    ...
    <div class="col-sm-12">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['method' =>'GET','route'=>'search-voucher-details/'.$id.'/'.$voucher_number]) !!}
                        ...
                        @if(isset($model))
                            @foreach($model as $values)
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <a href="{{ route('view-voucher-detail', $values->id) }}" class="btn btn-info btn-xs" data-toggle="modal" data-target="#etsbModal" data-placement="top" data-content="view"><i class="fa fa-eye"></i></a>
                                        @if($voucher_data->status !='posted')
                                        <a href="{{ route('edit-voucher-detail', $values->id) }}" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#etsbModal" data-placement="top" data-content="edit"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('destroy-voucher-detail', $values->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to Delete?')" data-placement="top" data-content="delete"><i class="fa fa-trash-o"></i></a>
                                         @endif
                                    </td>
                                </tr>
                            @endforeach

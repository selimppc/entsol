...
<div class="form-margin-btn">
    ...
    <a href="{{route('chart-of-accounts')}}" class=" btn btn-default" data-placement="top" data-content="click close button for close this entry form" onclick="close_modal();">Close</a>
</div>

    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ $pageTitle }} <strong>({{isset($voucher_number)?$voucher_number:''}})</strong></span>&nbsp;&nbsp;<span style="color: #A54A7B" class="user-guideline" data-content="<em>When Journal Voucher is balanced ,You can <b>Post</b> This Voucher At <b>'Post To Ledger'</b> Button.</em>">(?)</span>

                @if($voucher_data->status!='posted')
                    <a class="btn btn-xs btn-primary pull-right" data-toggle="modal" href="#addData" data-placement="left" data-content="click add voucher detail button for voucher debit and credit amount entry">
                       <strong>Add Reverse Detail</strong>
                    </a>
                @endif
            </div>
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['method' =>'GET','url'=>'/search-reverse-details/'.$id.'/'.$voucher_number]) !!}
                ...
                <div class="table-primary">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                        <thead>
                        <tr>
                            <th>Reverse #Number &nbsp;&nbsp;<span style="color: #A54A7B" class="user-guideline" data-placement="left" data-content="<em>below single voucher have multiple debit, credit entry based on chart of accounts code</em>">(?)</span></th>
                        ...
                        @if(isset($model))
                            @foreach($model as $values)
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <a href="{{ route('view-reverse-detail', $values->id) }}" class="btn btn-info btn-xs" data-toggle="modal" data-target="#etsbModal" data-placement="top" data-content="view"><i class="fa fa-eye"></i></a>
                                        @if($voucher_data->status !='posted')
                                        <a href="{{ route('edit-reverse-detail', $values->id) }}" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#etsbModal" data-placement="top" data-content="edit"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('delete-reverse-detail', $values->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to Delete?')" data-placement="top" data-content="delete"><i class="fa fa-trash-o"></i></a>
                                         @endif
                                    </td>
                                </tr>
                            @endforeach
                ...
                <a class="pull-right btn btn-xs btn-primary" href="{{ URL::route('reverse-voucher')}}"> <i class="fa fa-arrow-circle-left"></i> Back To Reverse Entry</a>
                <p>&nbsp;</p>

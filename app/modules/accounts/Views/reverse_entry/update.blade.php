...
{!! Form::model($data, ['method' => 'PATCH', 'route'=> ['update-reverse-voucher', $data[0]['id'],'id' => 'jq-validation-form' ]]) !!}
...
<div class="modal-body">
    ...
    <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
        <div class="row">
            {!! Form::hidden('account_type', 'reverse-entry') !!}
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                ...
                <div class="input-group date">
                    {!! Form::text('date', @$generate_voucher_number? date('Y/m/d') : @$data[0]['date'], ['class' => 'form-control bs-datepicker-example','required','title'=>'select journal voucher date']) !!}
...
<div class="modal-footer">
    ...
    <a href="{{route('reverse-voucher')}}" class=" btn btn-default" data-placement="top" data-content="click close button for close this entry form" onclick="close_modal();">Close</a>
</div>

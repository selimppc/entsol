<div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
        <div class="col-sm-6">
            ...
            {!! Form::text('menu_id', Input::old('menu_id'), ['id'=>'code', 'class' => 'form-control','required','autofocus','title'=>'enter menu id, example :: 1']) !!}
        </div>
        <div class="col-sm-6">
            {!! Form::label('menu_type', 'Menu Type:', ['class' => 'control-label']) !!}
            <small class="required">(Required)</small>
            {!! Form::select('menu_type', array('ROOT'=>'ROOT','MODU'=>'MODU','MENU'=>'MENU','SUBM'=>'SUBM'),Input::old('menu_type'),['class' => 'form-control','required','title'=>'select menu type']) !!}
        </div>
    </div>
</div>
...
<div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
        <div class="col-sm-6">
            ...
            <small class="required">(Required)</small>
            {!! Form::text('parent_menu_id', Input::old('parent_menu_id'), ['id'=>'parent_menu_id', 'class' => 'form-control','required','title'=>'enter parent menu id']) !!}
        </div>
        <div class="col-sm-6">
